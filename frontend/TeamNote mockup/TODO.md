...
## Steps (5/7 completed) - Auth UI reverted per feedback
...
### 6. [ ] Test: New signup → empty board; Delete account → list updates; Login verifies password
### 7. [ ] Update this TODO.md with completion status

## Testing
- `cd "frontend/TeamNote mockup" && npm run dev`
